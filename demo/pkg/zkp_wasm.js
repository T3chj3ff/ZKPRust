 ...
 * @returns {string}
 */
export function derive_public_key(secret_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function generate_proof(secret_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(secret_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {boolean}
 */
export function verify_proof(proof_hex, public_key_hex) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zkp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
